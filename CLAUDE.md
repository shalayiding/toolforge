...
**Option A — community tools** (recommended for new users): loads the 16 pre-built tools included in this repo (yfinance, YouTube transcripts, news, Mermaid diagrams, OSINT, email OSINT):
```bash
